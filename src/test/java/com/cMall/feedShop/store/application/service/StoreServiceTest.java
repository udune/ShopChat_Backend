...
class StoreServiceTest {
    ...
    void getMyStoreDetail_Success() {
        ...
        // when
        StoreDetailResponse result = storeService.getMyStoreDetail(USER_ID);
    ...
    void getMyStoreDetail_StoreNotFound() {
        ...
        // when & then
        assertThatThrownBy(() -> storeService.getMyStoreDetail(USER_ID))
    ...
    void getMyStoreDetail_NonExistentUserId() {
        ...
        // when & then
        assertThatThrownBy(() -> storeService.getMyStoreDetail(nonExistentUserId))
                .isInstanceOf(StoreException.class)
                .hasMessage(ErrorCode.STORE_NOT_FOUND.getMessage());
    ...
    void getMyStoreDetail_UserExistsButNoStore() {
        ...
        // when & then
        assertThatThrownBy(() -> storeService.getMyStoreDetail(userIdWithoutStore))
                .isInstanceOf(StoreException.class)
                .hasMessage(ErrorCode.STORE_NOT_FOUND.getMessage());
    ...
    void getMyStoreDetail_BuyerUser() {
        ...
        // when & then
        assertThatThrownBy(() -> storeService.getMyStoreDetail(buyerId))
                .isInstanceOf(StoreException.class)
                .hasMessage(ErrorCode.STORE_NOT_FOUND.getMessage());
